    ...
    <div class="calendar__calendar__year calendar__calendar__title bg_white">
        <button class="prev">
            <svg width="29" height="29" viewBox="0 0 29 29" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M17.8426 8.53239L11.8009 14.5741L17.8426 20.6157" stroke="#161E20" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"></path>
            </svg>
        </button>
        <section>
            <span>2022</span>
            <div>
                <svg width="30" height="29" viewBox="0 0 30 29" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M9.03239 11.1576L15.0741 17.1992L21.1157 11.1576" stroke="#161E20" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"></path>
                </svg>
            </div>
        </section>
        <button class="next">
            <svg width="29" height="29" viewBox="0 0 29 29" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M11.1574 20.4676L17.1991 14.4259L11.1574 8.38428" stroke="#161E20" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"></path>
            </svg>
        </button>
    </div>
